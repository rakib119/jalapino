        ...
        (e.fn.sectionSpace = function (t, a) {
            e(this).each(function () {
                ...
                (s = d.attr(t)),
                    ...
                    "margin-top" === s
                        ? (e(n).css("padding-bottom", l + c(o) + "px"), d.css("margin-top", "-" + c(o) + "px").css({ position: "relative", "z-index": "3" }))
                        : "margin-bottom" === s && (e(n).css("padding-top", r + c(i) + "px"), d.css("margin-bottom", "-" + c(i) + "px").css({ position: "relative", "z-index": "3" }));
            });
        });
